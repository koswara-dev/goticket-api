...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "GoTicket Support Team",
            "url": "http://www.goticket.com/support",
            "email": "support@goticket.com"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
        ...
        "/auth/resend-otp": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Resend OTP Request Payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/concerts": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search keyword for title, venue, or description",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sorting order (title_asc, title_desc, date_asc, date_desc)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Date of concert (RFC3339 or YYYY-MM-DD HH:mm)",
                        "name": "date",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "Description of concert",
                        "name": "description",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Status of concert",
                        "name": "status",
                        "in": "formData"
                    },
                    {
                    ...
                    {
                        "type": "file",
                        "description": "Concert Rules PDF file",
                        "name": "rules_pdf",
                        "in": "formData"
                    }
                ],
        ...
        "/customers": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search keyword (name, email, nik)",
                        "name": "search",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Sort order (name_asc, name_desc, email_asc, email_desc, nik_asc, nik_desc)",
                        "name": "sort",
                        "in": "query"
                    }
                ],
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.TicketCategory"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "dto.BookingRequest": {
            ...
            "properties": {
                ...
                "booking_details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dto.BookingDetailRequest"
                    }
                },
                "customer_id": {
                    "type": "integer"
        ...
        "model.Booking": {
            ...
            "properties": {
                ...
                "details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/model.BookingDetail"
                    }
                },
                "id": {
                    "type": "integer"
        ...
        "model.Customer": {
            ...
            "properties": {
                ...
                "nik": {
                    "description": "nik tidak boleh lebih dari 16 karakter dan kurang dari 16 karakter",
                    "type": "string"
                },
                "updated_at": {
                    "type": "string"
